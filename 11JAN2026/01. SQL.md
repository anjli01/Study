...
### [1. Relational Fundamentals and Set Logic](#1-relational-fundamentals-and-set-logic)
*   [1. Join Mechanics & Logic](#1-join-mechanics--logic)
*   [2. Advanced Join Scenarios](#2-advanced-join-scenarios)
*   [3. Aggregation & Logical Boundaries](#3-aggregation--logical-boundaries)
*   [4. NULL Handling & Data Quality](#4-null-handling--data-quality)
*   [5. Quick Revision Table: Set Operations](#5-quick-revision-table-set-operations)
*   [Final "L4" Tips for the Screen](#final-l4-tips-for-the-screen)

### [2. Advanced Analytical Functions (Window Functions)](#2-advanced-analytical-functions-window-functions)
*   [1. Core Syntax Refresher](#1-core-syntax-refresher)
*   [2. Ranking Mechanisms](#2-ranking-mechanisms)
*   [3. Top N & Deduplication Patterns](#3-top-n--deduplication-patterns)
*   [4. Positional Functions (LEAD & LAG)](#4-positional-functions-lead--lag)
*   [5. Running Aggregates & Framing](#5-running-aggregates--framing)
*   [6. Quick Comparison: Window vs. Group By](#6-quick-comparison-window-vs-group-by)
*   [7. Amazon-Specific Interview Tips](#7-amazon-specific-interview-tips)

### [3. Sequence Modeling and Gaps & Islands](#3-sequence-modeling-and-gaps--islands)
*   [1. Gaps and Islands: The "Island" Problem (Streaks)](#1-gaps-and-islands-the-island-problem-streaks)
*   [2. Gap Analysis (Inactivity & Missing Data)](#2-gap-analysis-inactivity--missing-data)
*   [3. Comparison Table: Islands vs. Gaps](#3-comparison-table-islands-vs-gaps)
*   [4. Preparation Checklist for Phone Screen](#4-preparation-checklist-for-phone-screen)

### [4. Business-Centric SQL Scenarios](#4-business-centric-sql-scenarios)
*   [1. Retention and Churn](#1-retention-and-churn)
*   [2. Cohort Analysis](#2-cohort-analysis)
*   [3. E-commerce Product Pairs](#3-e-commerce-product-pairs)
*   [4. Essential "Amazon-Style" SQL Functions](#4-essential-amazon-style-sql-functions)
*   [5. Final Tips for the Phone Screen](#5-final-tips-for-the-phone-screen)

### [5. Data Modeling and Optimization for SQL](#5-data-modeling-and-optimization-for-sql)
*   [1. Dimensional Modeling](#1-dimensional-modeling)
*   [2. Slowly Changing Dimensions (SCD) Type 2](#2-slowly-changing-dimensions-scd-type-2)
*   [3. SQL Performance & Optimization](#3-sql-performance--optimization)
*   [4. Amazon Redshift: Dist & Sort Keys](#4-amazon-redshift-dist--sort-keys)
*   [Quick Recall Tips for the Interview](#quick-recall-tips-for-the-interview)

### [6. Semi-Structured Data and Cleansing](#6-semi-structured-data-and-cleansing)
*   [1. Semi-Structured Data (JSON)](#1-semi-structured-data-json)
*   [2. Data Cleansing Functions](#2-data-cleansing-functions)
*   [3. Regular Expressions (RegEx)](#3-regular-expressions-regex)
*   [Quick Revision Tips for the Screening](#quick-revision-tips-for-the-screening)

### [7. Strategic Communication in the Interview](#7-strategic-communication-in-the-interview)
*   [1. The "Clarify Before Code" Framework](#1-the-clarify-before-code-framework)
*   [2. Strategic Communication Protocol](#2-strategic-communication-protocol)
*   [3. Production Readiness & Scalability](#3-production-readiness--scalability)
*   [4. Navigating Ambiguity (The L4 "Grading" Secret)](#4-navigating-ambiguity-the-l4-grading-secret)
*   [5. Quick Checklist for the Phone Screen](#5-quick-checklist-for-the-phone-screen)
