...
- [1. Foundational AWS Architecture: Redshift and S3](#1-foundational-aws-architecture-redshift-and-s3)
    - [1. Amazon Redshift (Data Warehouse)](#1-amazon-redshift-data-warehouse)
        - [A. Architecture Basics](#a-architecture-basics)
        - [B. Distribution Styles](#b-distribution-styles)
        - [C. Sort Keys](#c-sort-keys)
    - [2. S3 Data Lake & Storage](#2-s3-data-lake--storage)
        - [A. S3 Basics](#a-s3-basics)
        - [B. File Formats: Row vs. Columnar](#b-file-formats-row-vs-columnar)
        - [C. Partitioning & Pruning](#c-partitioning--pruning)
    - [Quick Recall Checklist for the Interviewer](#quick-recall-checklist-for-the-interviewer)
    - [Phone Screen Tips](#phone-screen-tips)
- [2. Pipeline Orchestration and ETL Concepts](#2-pipeline-orchestration-and-etl-concepts)
    - [Pipeline Orchestration](#pipeline-orchestration)
        - [1. Apache Airflow (The Industry Standard)](#1-apache-airflow-the-industry-standard)
        - [2. AWS Step Functions (The Serverless Alternative)](#2-aws-step-functions-the-serverless-alternative)
        - [Airflow vs. Step Functions](#airflow-vs-step-functions)
    - [Amazon-Specific Interview Tips (L4)](#amazon-specific-interview-tips-l4)
        - [Quick Prep Checklist](#quick-prep-checklist)
...
4.  **Ownership:** If a pipeline fails at 2 AM, how do you ensure the business stakeholders are notified and the data is backfilled? (This relates to Amazon’s Leadership Principles).
