...
- [1. Data Warehouse Fundamentals: Core Architectural Paradigms](#1-data-warehouse-fundamentals-core-architectural-paradigms)
    - [1. OLTP vs. OLAP: The Functional Split](#1-oltp-vs-olap-the-functional-split)
        - [Key L4 Concept: Why Columnar for OLAP?](#key-l4-concept-why-columnar-for-olap)
    - [2. Data Warehouse (DW) vs. Data Lake (DL)](#2-data-warehouse-dw-vs-data-lake-dl)
        - [Key L4 Concept: Schema-on-Write vs. Schema-on-Read](#key-l4-concept-schema-on-write-vs-schema-on-read)
    - [3. The "Lakehouse" Architecture (Modern DE Paradigm)](#3-the-lakehouse-architecture-modern-de-paradigm)
        - [Why Parquet?](#why-parquet)
    - [4. Data Modeling Fundamentals (L4 Must-Knows)](#4-data-modeling-fundamentals-l4-must-knows)
    - [5. Potential Phone Screen Questions (Quick Fire)](#5-potential-phone-screen-questions-quick-fire)
- [2. Amazon Redshift: Fundamental Architecture and Tuning](#2-amazon-redshift-fundamental-architecture-and-tuning)
    - [1. Fundamental Architecture](#1-fundamental-architecture)
        - [Massively Parallel Processing (MPP)](#massively-parallel-processing-mpp)
        - [Columnar Storage vs. Row-Based](#columnar-storage-vs-row-based)
    - [2. Distribution Styles](#2-distribution-styles)
    - [3. Sort Keys](#3-sort-keys)
    - [4. Data Loading: The COPY Command](#4-data-loading-the-copy-command)
        - [Best Practices for COPY](#best-practices-for-copy)
    - [5. Maintenance & Tuning Tips (Quick Hits)](#5-maintenance--tuning-tips-quick-hits)
    - [Possible "Phone Screen" Scenarios](#possible-phone-screen-scenarios)
- [3. Foundational Data Modeling](#3-foundational-data-modeling)
    - [1. Core Concepts: Fact vs. Dimension Tables](#1-core-concepts-fact-vs-dimension-tables)
    ...
    - [4. Practical Scenario: Tracking Customer Address Changes](#4-practical-scenario-tracking-customer-address-changes)
    - [5. Amazon-Specific Modeling Tips](#5-amazon-specific-modeling-tips)
    - [6. Quick Checklist for the Interview](#6-quick-checklist-for-the-interview)
- [4. ETL Engineering and Pipeline Integrity](#4-etl-engineering-and-pipeline-integrity)
    - [1. Core Concept: Idempotency](#1-core-concept-idempotency)
    - [2. Loading Strategies: Incremental vs. Full](#2-loading-strategies-incremental-vs-full)
        - [Change Data Capture (CDC)](#change-data-capture-cdc)
    - [3. Data Quality Validation](#3-data-quality-validation)
    - [4. Handling Failures & Backfilling](#4-handling-failures--backfilling)
    - [5. Amazon-Specific "L4" Interview Tips](#5-amazon-specific-l4-interview-tips)
    - [Example Scenario Questions to Practice](#example-scenario-questions-to-practice)
- [5. Programmatic Foundations and Algorithmic Strategy](#5-programmatic-foundations-and-algorithmic-strategy)
    - [1. Python Data Structures: Performance & Use Cases](#1-python-data-structures-performance--use-cases)
    - [2. Common Coding Patterns for L4 DE](#2-common-coding-patterns-for-l4-de)
    - [3. Complexity Analysis (Big O)](#3-complexity-analysis-big-o)
    - [4. Scale Considerations: "The Amazon Follow-up"](#4-scale-considerations-the-amazon-follow-up)
    - [5. Pythonic DE Best Practices](#5-pythonic-de-best-practices)
    - [6. Quick Checklist for the Interview](#6-quick-checklist-for-the-interview-1)
- [6. The AWS Ecosystem for Data Engineering](#6-the-aws-ecosystem-for-data-engineering)
    - [1. Amazon S3 (The Data Lake Foundation)](#1-amazon-s3-the-data-lake-foundation)
    - [2. AWS Glue (The Serverless ETL)](#2-aws-glue-the-serverless-etl)
    - [3. AWS Lambda (The Event-Driven Orchestrator)](#3-aws-lambda-the-event-driven-orchestrator)
    - [4. Amazon Athena (The Serverless Query Engine)](#4-amazon-athena-the-serverless-query-engine)
    - [Summary Table: Which service to use?](#summary-table-which-service-to-use)
    - [Quick Recall for the Interview](#quick-recall-for-the-interview)
...
To track a customer’s address change, your dimension table needs:
